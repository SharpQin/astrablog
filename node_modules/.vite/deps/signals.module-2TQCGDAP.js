...
function u(i2) {
  if (void 0 !== n) {
    var t3 = i2.n;
    if (void 0 === t3 || t3.t !== n) {
      t3 = { i: 0, S: i2, p: n.s, n: void 0, t: n, e: void 0, x: void 0, r: t3 };
      if (void 0 !== n.s)
        n.s.n = t3;
      n.s = t3;
      i2.n = t3;
...
p3.displayName = "_st";
Object.defineProperties(c.prototype, { constructor: { configurable: true, value: void 0 }, type: { configurable: true, value: p3 }, props: { configurable: true, get: function() {
  return { data: this };
...
//# sourceMappingURL=signals.module-2TQCGDAP.js.map
